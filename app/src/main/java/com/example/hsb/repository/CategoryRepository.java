                        ...
                        if (record.getExpand() != null) {
                            for (ServiceCategoryRecord serviceCategoryRecord : record.getExpand().getServiceCategoryRecordList()) {
                                ...
                                Service service = new Service(
                                        ...
                                        DateUtil.apiDateTimeStringToLocalDateTime(serviceRecordDetail.getStartTime()),
                                        DateUtil.apiDateTimeStringToLocalDateTime(serviceRecordDetail.getEndTime()),
                                        serviceRecordDetail.getRemark(),
                                        false,
                                        DateUtil.apiDateTimeStringToLocalDateTime(serviceRecordDetail.getCreated()),
                                        DateUtil.apiDateTimeStringToLocalDateTime(serviceRecordDetail.getUpdated())
                                );
