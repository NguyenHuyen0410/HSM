...
public class PriceRepository {
    ...
    private MutableLiveData<List<Price>> mListPriceLiveData = new MutableLiveData<>();
    ...
    private void fetchPriceList() {
        ...
        call.enqueue(new Callback<ListResponse<PriceRecord>>() {
            @Override
            public void onResponse(Call<ListResponse<PriceRecord>> call, Response<ListResponse<PriceRecord>> response) {
            ...
            @Override
            public void onFailure(Call<ListResponse<PriceRecord>> call, Throwable t) {
