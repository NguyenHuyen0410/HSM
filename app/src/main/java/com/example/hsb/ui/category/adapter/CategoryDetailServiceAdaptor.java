...
public class CategoryDetailServiceAdaptor extends RecyclerView.Adapter<CategoryDetailServiceAdaptor.CategoryDetailServiceHolder> {
    ...
    // Constructor
    public CategoryDetailServiceAdaptor(List<Service> childItemList, Context context) {
    ...
    @NonNull
    @Override
    public CategoryDetailServiceHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    public void onBindViewHolder(
            @NonNull CategoryDetailServiceHolder serviceCategoryChildHolder,
            int position) {
    ...
    class CategoryDetailServiceHolder extends RecyclerView.ViewHolder {

        TextView childItemTitle;

//        ImageView childItemImage;

        CategoryDetailServiceHolder(View itemView) {
            super(itemView);
