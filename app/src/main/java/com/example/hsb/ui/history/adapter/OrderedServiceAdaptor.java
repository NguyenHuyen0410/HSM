package com.example.hsb.ui.history.adapter;
...
import com.example.hsb.ui.history.activity.EditOrderedServiceDetail;
        ...
        for (Service service : serviceList) {
            if (service.getId().equals(serviceBillDetail.getServiceId())) {
                ...
                holder.layout.setOnClickListener(v -> {
                    Intent intent = new Intent(context, EditOrderedServiceDetail.class);
