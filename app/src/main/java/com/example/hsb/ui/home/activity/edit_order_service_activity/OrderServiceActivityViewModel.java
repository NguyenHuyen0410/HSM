...
public class OrderServiceActivityViewModel extends ViewModel {
    ...
    public OrderServiceActivityViewModel() {
        mServiceBill = new MutableLiveData<>();
        initData();
    }
    ...
    public void initData() {
        ...
        mServiceBill = serviceBillRepository.getServiceBill("is_deleted","false");
    }

    public MutableLiveData<List<ServiceBill>> getServiceBillLiveData() {
        return mServiceBill;
    }
